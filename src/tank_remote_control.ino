...
// The PPM Data Pin is the interrupt pin used to receive information from the
// radio transmitter, e.g. joystick position.

#define PPM_DATA_PIN 2

// The enable pins control the direction of the motors. (forward or reverse)

#define L_EN 3
#define R_EN 4

// The PWM inputs control the speed of the motors.

#define L_PWM 5
#define R_PWM 6

// I believe this returns the current draw, but currently this is unused.
// Theoretically you could use this to detect stalls for instance.
...
void loop()
{
  // FIXME: This timeout detection method was causing the motors to stutter.
